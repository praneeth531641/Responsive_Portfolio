...
const links = [
  { name: "Home", href: "#hero", icon: <HiHome className="text-indigo-500 text-lg" /> },
  { name: "Projects", href: "#projects", icon: <HiCollection className="text-indigo-500 text-lg" /> },
  { name: "Tech Stack", href: "#tech", icon: <HiCode className="text-indigo-500 text-lg" /> },
  { name: "Experience", href: "#experience", icon: <HiBriefcase className="text-indigo-500 text-lg" /> },
  { name: "Education", href: "#education", icon: <HiAcademicCap className="text-indigo-500 text-lg" /> },
  { name: "Contact", href: "#contact", icon: <HiMail className="text-indigo-500 text-lg" /> },
];
